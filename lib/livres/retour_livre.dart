...
class RetourLivre extends StatefulWidget {
  Livre? livre;
  Function afterSubmit;
  RetourLivre({super.key, required this.livre, required this.afterSubmit});

  @override
  State<RetourLivre> createState() => _RetourLivreState();
}

class _RetourLivreState extends State<RetourLivre> {
        ...
        final snackBar = SnackBar(
          content: const Row(
            children: [
              ...
              SizedBox(width: 8.0),
              Text(
                'Le livre a été rendu avec succès',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16.0,
                ),

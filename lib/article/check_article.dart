...
class CheckArticle extends StatefulWidget {
  Artilce? artilce;
  CheckArticle({super.key, required this.artilce});
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              SizedBox(width: 10),
                              Text(
                                'Le nombre d\'exemplaires de ce article : ${widget.artilce?.ouvrage.nombreExemplaire}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                              ...
                              SizedBox(width: 10),
                              Text(
                                'Le nombre de ce article qui est actuellement disponible : ${widget.artilce?.ouvrage.nombreDisponible}',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              RichText(
                                text: const TextSpan(
                                  text:
                                      'Le nombre maximal d\'adhérents pouvant emprunter cinq articles.',
                                  style: TextStyle(
                                    fontSize: 16.0,

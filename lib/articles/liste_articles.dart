      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          articles = List<Artilce>.from(
              data['articles'].map((x) => Artilce.fromJson(x)));
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const Text('Vous ne pouvez pas supprimer cet article.'),
                ],
              ),
              actions: [
                ElevatedButton(
                                                                    ...
                                                                    showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          title:
                                                                              Text(
                                                                            'Confirmation de suppression de l\'article',
                                                                            style:
                                                                                TextStyle(
                                                                              fontWeight: FontWeight.bold,
                                                                              fontSize: 18,

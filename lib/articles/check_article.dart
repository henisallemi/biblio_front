...
class CheckArticle extends StatefulWidget {
  Artilce? artilce;
  Function afterSubmit;
  CheckArticle({super.key, required this.artilce, required this.afterSubmit});

  @override
  State<CheckArticle> createState() => _CheckArticleState();
}

class _CheckArticleState extends State<CheckArticle> {
  ...
  Future<void> submit(Function closeForm) async {
    ...
    if (widget.artilce?.ouvrage?.nombreDisponible == 0) {
      print(widget.artilce?.ouvrage?.nombreDisponible);
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Padding(
              ...
              child: Text(
                "L'article '${widget.artilce?.ouvrage?.titre}' n\'est pas actuellement disponible dans la bibliothèque.",
                style: TextStyle(
                  fontSize: 16.0,
                  color: Colors.black,
                ),
        ...
        final snackBar = SnackBar(
          content: const Row(
            children: [
              ...
              SizedBox(width: 8.0),
              Text(
                "L'article a été pris avec succès",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16.0,
                ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              SizedBox(width: 10),
                              Text(
                                'Le nombre d\'exemplaires de cet article : ',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                              ...
                              Text(
                                '${widget.artilce?.ouvrage.nombreExemplaire}',
                                style: TextStyle(
                                  color: Colors.red,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                          ...
                          Row(
                            children: [
                              Text(
                                '  Le nombre de cet article qui est actuellement disponible : ',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                              ...
                              SizedBox(),
                              Text(
                                '${widget.artilce?.ouvrage.nombreDisponible}',
                                style: TextStyle(
                                  color: Colors.red,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
